(defproject munge "0.1.0-SNAPSHOT"
  ...
  :ring {:handler munge.handler/app
         :uberwar-name "munge.war"}

  :min-lein-version "2.5.0"

  :uberjar-name "munge.jar"
  ...
  :profiles {:dev {:repl-options {:init-ns munge.handler
             ...
             :production {:ring {:open-browser? false
                                 :stacktraces?  false
                                 :auto-reload?  false}
                          :cljsbuild {:builds {:app {:compiler {:main "munge.prod"}}}}
                          }})
